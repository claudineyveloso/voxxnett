                ...
                <div className="card-body p-4">
                  <div className="text-center mt-2">
                    ...
                    <p className="text-muted">
                      Faça login para continuar no VoxxNett.
                    </p>
                  </div>
                        ...
                        <div className="position-relative auth-pass-inputgroup input-custom-icon">
                          <span>
                            <svg
                              ...
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              className="feather feather-lock mt-0"
                            >
                              <rect
                                x="3"
                                y="11"
                          ...
                          <button
                            type="button"
                            className="btn btn-link position-absolute h-100 end-0 top-0 top-12"
                            id="password-addon"
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="text-center p-4">
                <p>
                  © {new Date().getFullYear()} VoxxNett. Desenvolvido por AIC -
