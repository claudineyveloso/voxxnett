                        ...
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="mb-3">
                              ...
                              />
                              <div className="invalid mt-1 ms-1">
                                {errors?.user?.user_name && <span>{errors?.user?.user_name.message}</span>}
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="mb-3">
                              ...
                              <select  {...register('user.user_type')}
                              ...
                              <div className="invalid mt-1 ms-1">
                                {errors?.user?.user_type && <span>{errors?.user?.user_type.message}</span>}
                              </div>
                            </div>
                          </div>
                        </div>
