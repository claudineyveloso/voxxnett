              ...
              <li className="nav-item">
                ...
                >
                  <svg
                    ...
                    className="feather feather-monitor icon nav-icon"
                  >
                    <rect
                      x="2"
                      y="3"
              ...
              <li className="nav-item dropdown">
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-grid icon nav-icon"
                  >
              ...
              <li className="nav-item dropdown">
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-briefcase icon nav-icon"
                  >
                    <rect
                      x="2"
                      y="7"
              ...
              <li className="nav-item dropdown">
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-archive icon nav-icon"
                  >
              ...
              <li className="nav-item dropdown active">
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-users icon nav-icon"
                  >
